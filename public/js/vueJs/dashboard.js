...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/dashboard/components/DashboardComponent.vue?vue&type=script&lang=js&":
/*!***************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/dashboard/components/DashboardComponent.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    updateDashboard: function updateDashboard(val) {
    ...
    getProgressPercent: function getProgressPercent(tasks) {
      var totalItems = 0;
      var self = this; // Get total items of user's tasks
    ...
    editTask: function editTask(task_id, key) {
      var self = this;
      self.taskModal['isShowModal'] = true;
      self.taskModal['formAction'] = 2; // Find task in tasks list using id
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/dashboard/components/DashboardComponent.vue?vue&type=template&id=7c3814b9&":
/*!*******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/dashboard/components/DashboardComponent.vue?vue&type=template&id=7c3814b9& ***!
  \*******************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        _c("div", { staticClass: "card" }, [
          _c("div", { staticClass: "card-body" }, [
                  ...
                  _c(
                    "div",
                    {
                      ...
                      attrs: {
                        role: "progressbar",
                        id: "PENDING",
                        "aria-valuenow": _vm.totalPercentage["PENDING"],
                        "aria-valuemin": "0",
                        "aria-valuemax": "100"
                      }
                    },
                    [_vm._v(_vm._s(_vm.totalPercentage["PENDING"]) + "%")]
                  ),
                  _vm._v(" "),
                  _c(
                    "div",
                    {
                      ...
                      attrs: {
                        role: "progressbar",
                        id: "ONGOING",
                        "aria-valuenow": _vm.totalPercentage["ONGOING"],
                        "aria-valuemin": "0",
                        "aria-valuemax": "100"
                      }
                    },
                    [_vm._v(_vm._s(_vm.totalPercentage["ONGOING"]) + "%")]
                  ),
                  _vm._v(" "),
                  _c(
                    "div",
                    {
                      ...
                      attrs: {
                        role: "progressbar",
                        id: "FINISHED",
                        "aria-valuenow": _vm.totalPercentage["FINISHED"],
                        "aria-valuemin": "0",
                        "aria-valuemax": "100"
                      }
                    },
                    [_vm._v(_vm._s(_vm.totalPercentage["FINISHED"]) + "%")]
                  ),
                  _vm._v(" "),
                  _c(
                    "div",
                    {
                      ...
                      attrs: {
                        role: "progressbar",
                        id: "DELAYED",
                        "aria-valuenow": _vm.totalPercentage["DELAYED"],
                        "aria-valuemin": "0",
                        "aria-valuemax": "100"
                      }
                    },
                    [_vm._v(_vm._s(_vm.totalPercentage["DELAYED"]) + "%")]
                  )
                ])
              ])
            ]),
            ...
            _c(
              ...
              [
                _c("div", { staticClass: "col-md-3 px-1 mb-2" }, [
                  _c(
                    "div",
                    {
                    ...
                    [
                      ...
                      _c(
                        ...
                        _vm._l(_vm.userTasks["PENDING"], function(
                          tasks,
                          task_key
                        ) {
                          return _c(
                            "div",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  return _vm.editTask(tasks.id, "PENDING")
                                }
                              }
                            },
                            [
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c(
                        "div",
                        { staticClass: "card-body" },
                        _vm._l(_vm.userTasks["ONGOING"], function(
                          tasks,
                          task_key
                        ) {
                          return _c(
                            "div",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  return _vm.editTask(tasks.id, "ONGOING")
                                }
                              }
                            },
                            [
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c(
                        "div",
                        { staticClass: "card-body" },
                        _vm._l(_vm.userTasks["FINISHED"], function(
                          tasks,
                          task_key
                        ) {
                          return _c(
                            "div",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  return _vm.editTask(tasks.id, "FINISHED")
                                }
                              }
                            },
                            [
                ...
                _c("div", { staticClass: "col-md-3 px-1 mb-2" }, [
                  _c(
                    "div",
                    {
                      staticClass: "card bg-danger text-white",
                      staticStyle: { height: "100%" }
                    },
                    [
                      _vm._m(4),
                      ...
                      _c(
                        "div",
                        { staticClass: "card-body" },
                        _vm._l(_vm.userTasks["DELAYED"], function(
                          tasks,
                          task_key
                        ) {
                          return _c(
                            "div",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  return _vm.editTask(tasks.id, "DELAYED")
                                }
                              }
                            },
                            [
      ...
      _c("task-modal", {
        ...
        on: {
          updateComponent: function($event) {
            return _vm.updateDashboard($event)
          }
        }
      })
    ],
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "card-header text-center" }, [
      _c("h5", { staticClass: "card-title" }, [_vm._v("PENDING")])
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "card-header text-center" }, [
      _c("h5", { staticClass: "card-title" }, [_vm._v("ONGOING")])
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "card-header text-center" }, [
      _c("h5", { staticClass: "card-title" }, [_vm._v("FINISHED")])
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "card-header text-center" }, [
      _c("h5", { staticClass: "card-title" }, [_vm._v("DELAYED")])
    ])
  }
]
render._withStripped = true
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_DashboardComponent_vue_vue_type_template_id_7c3814b9___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_DashboardComponent_vue_vue_type_template_id_7c3814b9___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_DashboardComponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/DashboardComponent */ "./resources/js/dashboard/components/DashboardComponent.vue");
window.Vue = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.common.js"); // GLOBAL COMPONENTS

Vue.component('task-modal', __webpack_require__(/*! ./../components/modals/TaskModalComponent.vue */ "./resources/js/components/modals/TaskModalComponent.vue")["default"]); // LOCAL COMPONENTS


var dashboard = new Vue({
  el: '#dashboardVue',
  components: {
    'dashboard-component': _components_DashboardComponent__WEBPACK_IMPORTED_MODULE_0__["default"]
  }
});
...
module.exports = __webpack_require__(/*! C:\Users\Rande\ProjectManagementSoftware\resources\js\dashboard\dashboard.js */"./resources/js/dashboard/dashboard.js");
